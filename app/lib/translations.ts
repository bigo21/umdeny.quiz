...
export const ui = {
  fr: {
    ...
    welcome: {
      bannerText: "Que vous soyez en Afrique ou dans la diaspora, ce quiz est conçu pour vous. Nos recommandations s'adaptent à votre situation géographique.",
      eyebrow: 'DIAGNOSTIC PATRIMONIAL · 5 MINUTES',
      titlePlain: 'Quel est votre',
      titleEm: 'profil patrimonial',
      titleEnd: '?',
      subtitle: "Répondez à 16 questions en 5 minutes et recevez instantanément une analyse personnalisée de votre situation, avec les stratégies et classes d'actifs les mieux adaptées à votre profil — gratuitement, par email.",
    ...
    capture: {
      ...
      subtitle: "Votre résultat détaillé vous sera envoyé gratuitement par email.\nNous ne partageons jamais vos données.",
      firstName: 'Prénom',
      lastName: 'Nom',
      email: 'Email',
      ...
      consentContact: "J'accepte d'être recontacté par l'équipe Umdeny Capital pour un accompagnement personnalisé.",
      consentRgpd: "J'accepte la",
      privacyLink: 'politique de confidentialité',
      consentRgpdEnd: "d'Umdeny Capital.",
      submit: 'Voir mon profil patrimonial',
      countries: [
        'Cameroun', "Côte d'Ivoire", 'Sénégal', 'France', 'Belgique',
        'Canada', 'États-Unis', 'Royaume-Uni', 'Allemagne', 'Maroc',
        'Gabon', 'RDC', 'Autre',
      ],
    ...
    result: {
      ...
      summary: (p: { pro: string; geo: string; horizon: string; capital: string; objectif: string; risque: string }) =>
      ...
      trustP1: "Umdeny Capital est une structure d'accompagnement patrimonial et d'investissement basée à Yaoundé, active au Cameroun et auprès de la diaspora africaine. Nous travaillons avec des investisseurs particuliers et des entrepreneurs pour structurer, diversifier et faire fructifier leur patrimoine — avec rigueur, transparence et une connaissance terrain du marché africain.",
      trustP2: "Chaque client est accompagné individuellement.",
      trustEmphasis: "Nous ne vendons pas des produits — nous construisons des stratégies.",
      defaultCta: 'Prendre un appel avec notre équipe',
      defaultCtaShort: 'Appel de 30 minutes · Gratuit · Sans engagement · Disponible en semaine',
  ...
  en: {
    ...
    welcome: {
      bannerText: "Whether you're in Africa or in the diaspora, this quiz was built for you. Our recommendations adapt to your geographic situation.",
      eyebrow: 'WEALTH ASSESSMENT · 5 MINUTES',
      titlePlain: 'What is your',
      titleEm: 'wealth profile',
      titleEnd: '?',
      subtitle: 'Answer 16 questions in 5 minutes and instantly receive a personalised analysis of your situation, with the strategies and asset classes best suited to your profile — free, by email.',
    ...
    capture: {
      ...
      subtitle: 'Your detailed result will be sent to you free by email.\nWe never share your data.',
      ...
      consentContact: 'I agree to be contacted by the Umdeny Capital team for personalised support.',
      consentRgpd: 'I accept the',
      privacyLink: 'privacy policy',
      consentRgpdEnd: 'of Umdeny Capital.',
      submit: 'See my wealth profile',
      countries: [
        'Cameroon', "Côte d'Ivoire", 'Senegal', 'France', 'Belgium',
        'Canada', 'United States', 'United Kingdom', 'Germany', 'Morocco',
        'Gabon', 'DRC', 'Other',
      ],
    ...
    result: {
      ...
      trustP1: 'Umdeny Capital is a wealth management and investment advisory firm based in Yaoundé, active in Cameroon and with the African diaspora. We work with individual investors and entrepreneurs to structure, diversify and grow their wealth — with rigour, transparency and first-hand knowledge of the African market.',
      ...
      defaultCtaShort: '30-minute call · Free · No commitment · Available weekdays',
