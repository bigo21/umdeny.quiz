...
export async function POST(req: NextRequest) {
  ...
  const record = {
    ...
    age_range: single(answers.Q2),
    situation_pro: single(answers.Q3),
    secteur: single(answers.Q4),
    experience: single(answers.Q5),
    objectif: single(answers.Q6),
    capital_range: single(answers.Q7),
    mode_investissement: single(answers.Q8),
    patrimoine_existant: single(answers.Q9),
    horizon: single(answers.Q10),
    projet_vie: single(answers.Q11),
    reaction_perte: single(answers.Q12),
    niveau_risque: single(answers.Q13),
    implication: single(answers.Q14),
    affinites: multi(answers.Q15),
    valeurs: single(answers.Q16),
    frein: single(answers.Q17),
